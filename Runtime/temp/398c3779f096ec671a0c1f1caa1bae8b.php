<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/Library/WebServer/www/project/sep-7/application/user/view/member/manage.html";i:1505228646;s:77:"/Library/WebServer/www/project/sep-7/application/common/view/public/base.html";i:1505197405;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
            ...
            <div class="form-horizontal ">
                <div class="box-body">
                    <div class="form-group choose-member-type">
                        <div class="radio">
                          <input class="iradio_flat-green" type="radio" name="member_type"  value="1" checked="checked">
                            <label>
                               1个月30元
                            </label>
                        </div>
                    ...
                    <div class=" form-group choose-member-type">
                        <div class="radio">
                          ...
                          <input class="iradio_flat-green" type="radio" name="member_type"  value="3" >
                            <label>
                                3个月78元 ( <span class="red-span">26</span>元/月 )
                            </label>
                        </div>
                    </div>
                    <div class="form-group choose-member-type">
                        <div class="radio">
                            ...
                            <input class="iradio_flat-green" type="radio" name="member_type"  value="6" >
                            <label>
                               6个月120元 ( <span class="red-span">20</span>元/月 )
                            </label>
                        </div>
                    </div>
                    <div class="form-group choose-member-type">
                        ...
                        <input class="iradio_flat-green" type="radio" name="member_type" id="" value="12" >
                            <label>
                                12个月180元 ( <span class="red-span">15</span>元/月 )
                    ...
                    <div class="submit-member-type" >
                        ...
                        <!--<input type="button" class="btn  btn-warning btn-lg" id="payment-btn"  value="立即支付">-->
                    </div>
