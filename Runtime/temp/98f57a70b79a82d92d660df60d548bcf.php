<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/Library/WebServer/www/project/sep-7/application/user/view/member/index.html";i:1505140025;s:77:"/Library/WebServer/www/project/sep-7/application/common/view/public/base.html";i:1505197405;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
...
<section class="content">
    <div class="box box-solid clearfix">
        <div class="box-body clearfix member-content">
            ...
            <?php if($is_vip == 1): ?>
            <span>尊敬的VIP用户,您的会员到期时间为:<?php echo $expir_time; ?>, <a href="/user/member/manage">点击这里续费</a></span>
            <?php endif; if($is_vip == 0): ?>
                <span>您还不是VIP用户,<a href="/user/member/manage"> 点击这里立即升级为VIP用户</a></span>
            <?php endif; if($is_vip == -1): ?>
            <span>尊敬的VIP用户,您的会员已到期 <a href="/user/member/manage">点击这里续费</a></span>
            <?php endif; ?>
